...
const Hero = () => {
  return (
    <section className='max-container padding-container flex flex-col gap-20 py-10 pd-32 md:gap-28 lg:py-20 xl:flex-row border-2 border-red-500'>
        ...
        <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
            ...
            <h1 className='bold-52 lg:bold-88'>Andriake Camp</h1>
            ...
            <div className='my-11 flex flex-wrap gap-5'>
                ...
                <p className='bold-16 lg:bold-20 text-blue-70'>198k
                    <span className='regular-16 lg:regular-20 ml-1'>Excellent Reviwes</span>
                </p>
            </div>
